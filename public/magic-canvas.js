jQuery.magicCanvas = {
    draw: function (opt) {
        ...
        function scroll() {
            target.x = target.rx + document.getElementById("home") .scrollLeft + document.documentElement.scrollLeft;
            target.y = target.ry + document.getElementById("home") .scrollTop + document.documentElement.scrollTop;
        }
        ...
        function mouseMove(e) {
            ...
            if (e.pageX || e.pageY) {
                ...
                target.x = e.clientX + document.getElementById("home") .scrollLeft + document.documentElement.scrollLeft;
                target.y = e.clientY + document.getElementById("home") .scrollTop + document.documentElement.scrollTop;
            }
            target.rx = e.clientX;
            target.ry = e.clientY;
        }
